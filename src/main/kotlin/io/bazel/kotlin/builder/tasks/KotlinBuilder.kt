...
import io.bazel.kotlin.builder.tasks.common.KotlinKlibTaskExecutor
...
class KotlinBuilder
  ...
  private fun buildKlibTask(info: CompilationTaskInfo, workingDir: Path, argMap: ArgMap): KlibCompilationTask =
