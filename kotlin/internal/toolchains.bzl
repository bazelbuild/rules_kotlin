...
def _kotlin_toolchain_impl(ctx):
    ...
    toolchain = dict(
        ...
        experimental_prune_transitive_deps = ctx.attr.experimental_prune_transitive_deps,
...
_kt_toolchain = rule(
    ...
    attrs = {
        ...
        "experimental_prune_transitive_deps": attr.bool(
            doc = "Removes transitive dependencies from compilation classpath",
            default = False,
        ),
...
def define_kt_toolchain(
    ...
    _kt_toolchain(
        ...
        experimental_prune_transitive_deps = experimental_prune_transitive_deps,
