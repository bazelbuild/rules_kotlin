...
def _run_kt_builder_action(
    ...
    args.add("--internal_plugin", toolchains.kt.internal_jvm_abi_gen, format = "jvm_abi_gen=%s")
    args.add("--internal_plugin", toolchains.kt.internal_skip_code_gen, format = "skip_code_gen=%s")
    args.add("--internal_plugin", toolchains.kt.internal_kapt, format = "kapt=%s")
    args.add("--internal_plugin", toolchains.kt.internal_jdeps_gen, format = "jdeps=%s")
