...
| <a id="kt_ksp_plugin-target_embedded_compiler"></a>target_embedded_compiler |  Deprecated compatibility attribute; no-op in BTAPI-based plugin wiring.   | Boolean | optional |  `False`  |
