...
| <a id="kt_kotlinc_options-x_allow_no_source_files"></a>x_allow_no_source_files |  Allow the set of source files to be empty.   | Boolean | optional |  `False`  |
...
| <a id="kt_kotlinc_options-x_compile_java"></a>x_compile_java |  Reuse 'javac' analysis and compile Java source files.   | Boolean | optional |  `False`  |
...
| <a id="kt_kotlinc_options-x_disable_standard_script"></a>x_disable_standard_script |  Disable standard Kotlin scripting support.   | Boolean | optional |  `False`  |
...
| <a id="kt_kotlinc_options-x_no_reset_jar_timestamps"></a>x_no_reset_jar_timestamps |  Don't reset jar entry timestamps to a fixed date.   | Boolean | optional |  `False`  |
...
| <a id="kt_kotlinc_options-x_output_builtins_metadata"></a>x_output_builtins_metadata |  Output builtins metadata as .kotlin_builtins files   | Boolean | optional |  `False`  |
...
| <a id="kt_kotlinc_options-x_use_javac"></a>x_use_javac |  Use javac for Java source and class file analysis.   | Boolean | optional |  `False`  |
| <a id="kt_kotlinc_options-x_use_k2_kapt"></a>x_use_k2_kapt |  Enable the experimental support for K2 KAPT.   | Boolean | optional |  `False`  |
